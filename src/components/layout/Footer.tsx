      ...
      <div className="max-w-[1600px] mx-auto px-4 md:px-8 lg:px-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
        ...
        <div className="flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-4 text-sm font-light text-gray-200">
            ...
            <li><a href="/donation" className="hover:text-white transition-colors text-white font-medium">Support & Partner With Us</a></li>
      ...
      <div className="w-full flex justify-center gap-4 mt-16 pt-8 border-t border-white/10">
        {[
          ...
          <a
            ...
            aria-label={s.label}
            className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center text-white hover:bg-white/40 hover:scale-110 transition-all duration-200"
          >
